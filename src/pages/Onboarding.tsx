      ...
      <div className="relative z-10 flex flex-col min-h-screen max-w-[560px] mx-auto w-full">
        ...
        {isLastStep && answers[step.key] && (
          <button
            ...
            disabled={saving}
            className="mt-auto self-center text-white/60 font-body text-[14px] underline underline-offset-4 decoration-white/30 transition-all duration-300 hover:text-white/90 hover:decoration-white/60 disabled:opacity-30 disabled:cursor-not-allowed"
          >
            {saving ? (
