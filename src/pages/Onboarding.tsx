...
const Onboarding = () => {
  ...
  return (
    <div className="relative w-full mx-auto min-h-screen flex flex-col overflow-hidden bg-black">
      <img src={onboardingBg} alt="" className="absolute inset-0 w-full h-full object-cover object-bottom" aria-hidden="true" />
