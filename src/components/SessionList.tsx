...
const SessionList = ({ sessions, categoryImage, categoryLabel, sessionRoute, currentTitle }: SessionListProps) => {
          ...
          return (
            ...
            >
              ...
              <AddToCalendar
                ...
                trigger={
                  <button
                    className="flex-shrink-0 w-8 h-8 rounded-lg bg-white/[0.08] flex items-center justify-center text-white/40 hover:text-white/70 hover:bg-white/[0.15] transition-colors"
